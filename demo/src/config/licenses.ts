/** Third-party components bundled with or downloaded by Verity, with licenses. */
...
export const THIRD_PARTY: ThirdPartyItem[] = [
  ...
  { name: "Interface typography", license: "System fonts only", url: "", note: "Verity uses the operating system font stack (Segoe UI on Windows). No web fonts are bundled or fetched." },
