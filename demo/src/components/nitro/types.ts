...
export type Chapter = { id: number; subjectId: number; name: string; position: number; noteCount: number; createdAt: string; updatedAt: string };
export type Subject = { id: number; name: string; description: string; position: number; noteCount: number; chapters: Chapter[]; createdAt: string; updatedAt: string };
