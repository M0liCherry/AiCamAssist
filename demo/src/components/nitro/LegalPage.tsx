...
export const policies: Record<PolicyKey, Policy> = {
  privacy: {
    ...
    sections: [
      ...
      { heading: "7. Children", paragraphs: ["Verity is not directed at children under 13 (or the minimum age of digital consent in your region). Schools deploying the app should review applicable student-privacy rules (e.g. FERPA/COPPA) and the cloud-provider option before use."] },
  ...
  terms: {
    ...
    summary: "Acceptable use, AI limitations, and liability terms for the Verity desktop software.",
    sections: [
  ...
  telemetry: {
    ...
    summary: "Verity ships with zero telemetry. This page documents exactly what the optional diagnostics switch does.",
    sections: [
  ...
  license: {
    ...
    sections: [
      ...
      { heading: "2. Price and purchases", paragraphs: ["This version of Verity contains no in-app purchases, subscriptions, trials, or licence keys. Any fees charged by third-party AI providers or model hosts are governed solely by those providers. If a paid edition is offered in the future, the price, billing interval, trial length, renewal rules, and refund terms will be shown before purchase and documented here."] },
      { heading: "3. Refunds", paragraphs: ["Because nothing is charged for this edition, no refund can arise from it. If you obtained Verity through a store or reseller, that store's refund policy applies to the transaction. Statutory withdrawal and refund rights in your jurisdiction are never limited by this policy."] },
  ...
  accessibility: {
    ...
    summary: "How Verity approaches WCAG 2.1 AA and where the current limitations are.",
    sections: [
      { heading: "1. Commitment", paragraphs: ["Verity is built to meet WCAG 2.1 Level AA: semantic landmarks and headings, labelled controls, visible focus indicators, high-contrast colour tokens in both themes, reflow down to narrow window sizes, and reduced-motion support."] },
  ...
  licenses: {
    ...
    summary: "Third-party software, icons, fonts, and model weights used by Verity, with their licences.",
