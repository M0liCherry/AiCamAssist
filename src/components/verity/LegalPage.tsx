...
export const policies: Record<PolicyKey, Policy> = {
  privacy: {
    ...
    sections: [
      { heading: "1. Local-first by design", paragraphs: [`${APP_NAME} is a local-first web application. Your subjects, chapters, notes, extracted text, retrieval chunks and embeddings, chat history, generated podcasts, flashcard decks, quiz attempts, transcripts, and settings are stored in the configured local data directory.`] },
  ...
  terms: {
    ...
    sections: [
      { heading: "1. The software", paragraphs: [`These terms cover the ${APP_NAME} application (version ${APP_VERSION}) provided by ${PUBLISHER.name}. By using it you agree to these terms and to the License, Refunds & Support policy.`] },
  ...
  telemetry: {
    ...
    sections: [
      { heading: "1. No cookies, no analytics", paragraphs: ["The app uses no advertising or analytics cookies, no third-party scripts, and no tracking SDKs. Interface preferences (theme, consent timestamps) are stored in the local database, not in cookies."] },
  ...
  license: {
    ...
    sections: [
      { heading: "1. Licence grant", paragraphs: [`${PUBLISHER.name} grants you a personal, non-exclusive, non-transferable licence to use ${APP_NAME} for personal study and note-taking. You may not redistribute, sell, sublicense, or reverse engineer the application except to the extent permitted by law or by the open-source licences of its components (see Open-source licenses).`] },
      ...
      { heading: "4. Support", paragraphs: [`Support is provided on a best-effort basis by email at ${PUBLISHER.supportEmail}. Include the app version (shown in Settings → About), the AI backend in use, and — if you enabled it — the local diagnostics log.`] },
      ...
      <div className="legal-shell">
        ...
        <article className="policy-article">
          ...
          <section className="operator-card">
            ...
            <dl>
              <div><dt>Product</dt><dd>{APP_NAME} {APP_VERSION}</dd></div>
