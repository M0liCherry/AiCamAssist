...
export const policies: Record<PolicyKey, Policy> = {
  ...
  terms: {
    ...
    summary: "Acceptable use, AI limitations, and liability terms for the VerityAI desktop software.",
    sections: [
